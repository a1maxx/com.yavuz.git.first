...
public class ModifiedNR0_1 {
	...
	public static void main(String[] args){
		...
		innerloop: for (int i = 1; i <= 5000 && flag; i++) {
			double w0 = 1.00;
			double v0 = 1.01;
...
//					
					...
					double[][] arJacob = ModifiedNR.artificialJacob2(deltaVoltageOrders, buses, wi,
							indexes, radmittances, xadmittances, DELTA, X0);
