...
public class ModifiedNR10 {
	public static final double loadMean = 0.15;
	public static final double loadSD = loadMean * 0.1;
	public static final double v0 = 1.04;
	public static final double w0 = 1.004;
	...
	public static void main(String[] args) {
		...
		Particle[] particles = mnr10.initializeParticles(npar);
		...
		double[] bestPosition = new double[20];
		...
		particles = mnr10.initializeParticles(npar);
		...
		for (iteration = 1; iteration < max_iter; iteration++) {
			...
			boolean flag = false;
				...
				for (Particle particle2 : particles) 
					mnr10.experimentParticle(particle2, n0);
				...
				mnr10.makeAdditionalReps3(particles, budget, bestFitness, res, best);
				bestFitness = best.getFitness();
			...
			if (rep > 0) {
				for (int k = 0; k < rep; k++) {
					...
					while (flag3) {
						...
						buses.add(new Bus(1, 32, params, generateFromWind(wb.sample(), 3.5, 20.0, 14.5, 0.75)));
						...
						buses.add(new Bus(1, 44, params, generateFromWind(wb2.sample(), 3.5, 20.0, 14.5, 0.75)));
						...
						buses.add(new Bus(1, 56, params, generateFromWind(wb.sample(), 3.5, 20.0, 14.5, 0.75)));
	...
	public void experimentParticle(Particle p, int rep) {
		...
		for (int k = 0; k < rep; k++) {
			...
			while (flag2) {
				...
				buses.add(new Bus(2, 6, params, 0, 0, position[0], position[10], 0.6, 0.8)); // 3
				buses.add(new Bus(1, 8, params, generateFromWind(wb.sample(), 3.5, 20.0, 14.5, 0.75))); // 4
				buses.add(new Bus(2, 10, params, 0, 0, position[1], position[11], 0.9, 1.2)); //5
				buses.add(new Bus(1, 12, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(1, 14, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(1, 16, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(2, 18, params, 0, 0, position[2], position[12], 0.6, 0.8)); // 9
				buses.add(new Bus(1, 20, params, generateFromWind(wb2.sample(), 3.5, 20.0, 14.5, 0.75))); // 10
				buses.add(new Bus(2, 22, params, 0, 0, position[3], position[13], 0.9, 1.2));
				buses.add(new Bus(1, 24, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(1, 26, params,  Math.min(-normal.sample(),0))); // 13
				buses.add(new Bus(1, 28, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(2, 30, params, 0, 0, position[4], position[14], 0.6, 0.8)); //15
				buses.add(new Bus(1, 32, params, generateFromWind(wb.sample(), 3.5, 20.0, 14.5, 0.75)));
				buses.add(new Bus(2, 34, params, 0, 0, position[5], position[15], 0.9, 1.2));
				buses.add(new Bus(1, 36, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(1, 38, params,  Math.min(-normal.sample(),0))); // 19
				buses.add(new Bus(1, 40, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(2, 42, params, 0, 0, position[6], position[16], 0.6, 0.8)); //21
				buses.add(new Bus(1, 44, params, generateFromWind(wb2.sample(), 3.5, 20.0, 14.5, 0.75)));
				buses.add(new Bus(2, 46, params, 0, 0, position[7], position[17], 0.9, 1.2));
				buses.add(new Bus(1, 48, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(1, 50, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(1, 52, params,  Math.min(-normal.sample(),0))); // 26
				buses.add(new Bus(2, 54, params, 0, 0, position[8], position[18], 0.6, 0.8));
				buses.add(new Bus(1, 56, params, generateFromWind(wb.sample(), 3.5, 20.0, 14.5, 0.75)));
				buses.add(new Bus(2, 58, params, 0, 0, position[9], position[19], 0.9, 1.2)); // 29
				
				flag2 = ModifiedNR.checkAdequacy(buses, 12.5);
			}
			ArrayList<ArrayList<Integer[]>> deltaVoltageOrders = ModifiedNR.createOrders2(buses);
			ArrayList<ArrayList<Integer>> indexes = ModifiedNR.identifyNet(buses);
	...
	public double[] construct() {
		...
		while (flag2) {
			...
			while (flag3) {
				...
				buses.add(new Bus(1, 2, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(1, 4, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(2, 6, params, 0, 0, random.nextDouble()*3-1, random.nextDouble()*3-1, 0.6, 0.8));
				buses.add(new Bus(1, 8, params, generateFromWind(wb.sample(), 3.5, 20.0, 14.5, 0.75)));
				buses.add(new Bus(2, 10, params, 0, 0, random.nextDouble()*3-1, random.nextDouble()*3-1, 0.9, 1.2));
				buses.add(new Bus(1, 12, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(1, 14, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(1, 16, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(2, 18, params, 0, 0, random.nextDouble()*3-1, random.nextDouble()*3-1, 0.6, 0.8));
				buses.add(new Bus(1, 20, params, generateFromWind(wb2.sample(), 3.5, 20.0, 14.5, 0.75)));
				buses.add(new Bus(2, 22, params, 0, 0, random.nextDouble()*3-1, random.nextDouble()*3-1, 0.9, 1.2));
				buses.add(new Bus(1, 24, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(1, 26, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(1, 28, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(2, 30, params, 0, 0, random.nextDouble()*3-1, random.nextDouble()*3-1, 0.6, 0.8));
				buses.add(new Bus(1, 32, params, generateFromWind(wb.sample(), 3.5, 20.0, 14.5, 0.75)));
				buses.add(new Bus(2, 34, params, 0, 0, random.nextDouble()*3-1, random.nextDouble()*3-1, 0.9, 1.2));
				buses.add(new Bus(1, 36, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(1, 38, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(1, 40, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(2, 42, params, 0, 0, random.nextDouble()*3-1, random.nextDouble()*3-1, 0.6, 0.8));
				buses.add(new Bus(1, 44, params, generateFromWind(wb2.sample(), 3.5, 20.0, 14.5, 0.75)));
				buses.add(new Bus(2, 46, params, 0, 0, random.nextDouble()*3-1, random.nextDouble()*3-1, 0.9, 1.2));
				buses.add(new Bus(1, 48, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(1, 50, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(1, 52, params,  Math.min(-normal.sample(),0)));
				buses.add(new Bus(2, 54, params, 0, 0, random.nextDouble()*3-1, random.nextDouble()*3-1, 0.6, 0.8));
				buses.add(new Bus(1, 56, params, generateFromWind(wb.sample(), 3.5, 20.0, 14.5, 0.75)));
				buses.add(new Bus(2, 58, params, 0, 0, random.nextDouble()*3-1, random.nextDouble()*3-1, 0.9, 1.2));
	...
	public void addSamples(Particle p, int rep) {
		...
		for (int k = 0; k < rep; k++) {
			...
			while (flag4) {
				...
				flag4 = ModifiedNR.checkAdequacy(buses, 12.5);
			}
